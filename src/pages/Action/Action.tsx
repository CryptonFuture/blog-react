...
import { actionColumns } from "../../components/useColumn/actionColumn";
import type { Actions } from '../../utils/Interface/User'
...
const ActionActions: ActionItem<Actions>[] = [
...
export const Action: React.FC<PostProps> = () => {
  const { getColumnSearchProps } = useColumnSearch<Actions>();
